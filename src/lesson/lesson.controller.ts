import { Body, Controller, Delete, FileTypeValidator, Get, HttpException, HttpStatus, ParseFilePipe, Patch, Post, Put, Query, UploadedFile, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class LessonController {
    ...
    ) file: Express.Multer.File, @Body() body: GetLessonDto){
        const payload = {
            file,
            email: body.email,
